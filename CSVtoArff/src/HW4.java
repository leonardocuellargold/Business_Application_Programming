...
public class HW4 {
    ...
    //***********************************************************************************************
        //to do:
            ...
            System.out.println("What file would you like to look in?");
            String output = String.format("%s/%s", directoryPath, scn.nextLine());
            System.out.println("What column would you like to look in?");
            int row= scn.nextInt();
            System.out.println("What row would you like to look in?");
            ...
            arffOutPut.RetrieveCell(output,row,column);
               ...
               System.out.println(arffOutPut.RetrieveCell(output,row,column));
    }
	/**
